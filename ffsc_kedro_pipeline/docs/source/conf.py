...
from src.ffsc import __version__ as release
...
latex_documents = [
    (master_doc, "ffsc.tex", "ffsc Documentation", "QuantumBlack", "manual")
]
...
man_pages = [(master_doc, "ffsc", "ffsc Documentation", [author], 1)]
